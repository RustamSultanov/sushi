...
urlpatterns = [
    ...
    path('employee/<int:user_id>/shops_by_sign/<int:sign_id>', login_required(views.EmployeeSignShopsView.as_view()),
         name='employee_sign_shops'),
    ...
    path('partner/<int:user_id>', login_required(views.PartnerDetailView.as_view()), name='partner_info'),
    path('partner/edit/<int:user_id>', views.edit_partner_view, name='edit_partner'),
    path('partner/delete/<int:user_id>', login_required(views.PartnerDeleteView.as_view()), name='delete_partner'),
    ...
    path('employee/<int:user_id>/tasks/', views.EmployeeTasksListView.as_view(), name='employee_tasks_list'),
    path(
    ...
    path(
        ...
        name='shop'),
    path('shop/<int:shop_id>/edit', login_required(views.ShopFormView.as_view()), name='shop_edit'),
    path('shop/<int:shop_id>/delete', login_required(views.ShopDeleteView.as_view()), name='shop_delete'),
